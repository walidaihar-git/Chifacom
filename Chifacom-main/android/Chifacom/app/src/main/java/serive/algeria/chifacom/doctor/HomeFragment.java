...
public class HomeFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ColorDrawable colorDrawable
                = new ColorDrawable(Color.parseColor("#F6F5F5"));
...
//        profile.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        if (v == workNav ){
            ...
            // change bottom navigation item
            ChipNavigationBar chipNavigationBar = getActivity().findViewById(R.id.chipNavigationBar);
            chipNavigationBar.setItemSelected(R.id.room,true);
        }
        if (v == profileNav){
